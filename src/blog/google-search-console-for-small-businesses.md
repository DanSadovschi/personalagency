---
title: Google Search Console — The Free Tool Every UK Business Should Be Using (But Isn't)
description: Google Search Console shows you exactly what people type to find your website, which pages rank, and what's broken. It's free, it's from Google, and most small businesses have never opened it.
date: 2026-03-03
category: SEO
readTime: 6 min read
canonical: https://web-orb.uk/blog/google-search-console-for-small-businesses/
ogTitle: Google Search Console — The Free Tool Every UK Business Should Be Using | WebOrb
---
...
It's called [Google Search Console](https://search.google.com/search-console/about). And the majority of small UK businesses have either never set it up, or connected it once and never looked at it again.
...
3. Verify ownership — easiest method is via [Google Analytics](https://analytics.google.com) if you already have that set up, otherwise via an HTML file upload or DNS record
